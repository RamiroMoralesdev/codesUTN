...
public class TpColecciones {
    ...
    public static void main(String[] args) {
        ...
        Profesor prof1 = new Profesor("101", "Charly", "Cimino",   "Programacion");
        Profesor prof2 = new Profesor("102", "Ariel ", "Enferrel", "Programacion");
        Profesor prof3 = new Profesor("103", "Cintia", "Rigoni", "Programacion"); 
